...
<head>
    ...
    <link href="<?php echo base_url() ?>assets/css/themify-icons/css/themify-icons.css" rel="stylesheet" type="text/css" />
    <!-- end of global css-->
    <!-- page level styles-->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-10 col-sm-6 m-auto  box animated fadeInUp">
                <div class="text-center"><img src="<?php echo base_url() ?>assets/img/logo_white.png" alt="Clear logo"></div>
                ...
                <form action="<?php echo site_url("account/forgotpass"); ?>" class="forgot_Form text-center" method="POST" id="forgot_password">
