...
<head>
    ...
    <link href="<?= base_url() ?>assets/vendors/toastr/css/toastr_notificatons.css" rel="stylesheet">
...
<body id="sign-in">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="login" id="authentication" method="post" class="login_validator">
                                ...
                                <a href="<?= site_url("account/forgotpass"); ?>" id="forgot" class="forgot"> Forgot Password ? </a>

                                <span class="float-right sign-up">New ? <a href="<?= site_url("account/signup"); ?>">Sign Up</a></span>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script src="<?= base_url() ?>assets/vendors/toastr/js/toastr.min.js"></script>
    <script src="<?= base_url() ?>assets/vendors/toastr/js/toastr_notifications.js"></script>
