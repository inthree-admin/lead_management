   ...
   <div class="wrapper row-offcanvas row-offcanvas-left">
      ...
      <section class="content">
         ...
         <div class="row">
			...
			?>			
            <tbody>               
				<tr><th>Reference</th><td><?= $row['reference']; ?></td><th colspan="2">Order #</th><td><?= $row['orderid']; ?></td></tr>
				<tr><th>Shipment #</th><td><?= $row['shipmentid']; ?></td><th colspan="2">Status</th><th><font color="Green"><b><?php echo $status; ?></b></font></th></tr>
				<tr><th>Customer Name</th><td><?= $row['customer_name']; ?></td>
				<?php if($row['care_of_name']){ ?><th>Care of</th><td><?= $row['care_of_name']; ?></td> <?php }?></tr>    
<tr><th>Mobile</th><td><?= $row['customer_contact_number']; ?></td></tr>                
<!--<tr><th>Customer Name</th><td><?= $row['customer_name']; ?></td><th>Mobile</th><td><?= $row['customer_contact_number']; ?></td></tr>-->
                     ...
                     <tbody>
                        ...
                        <tr>
                         ...
                         <tr>
                           <td colspan="2">
                              <?= $row['verified_mobile']; ?><img src="<?= base_url()?>assets/images/ok.png"><font color='green'><b>Verified</b></font>
                           </td>
            ...
            <!--Delivery   -->
                  ...
                  <table id="inventory2"  class="table table-bordered table-striped ">
                     ...
                     <tbody>
					   ...
					   <tr>
						...
						-->
						<!--For Pickup and delivery only end-->
						<?php } ?>
                     </tbody>
                     <?php } ?>
                  </table>
               ...
               <div class="box-body table-responsive">
                   <p><h2 class="card-title">
                <i class="ti-layout-grid3"></i> <font color="blue"><b>Undelivered Attempt Details</b></font>
                   </h2><p></p>
               ...
               <div class="box-body table-responsive">
                   <p><h2 class="card-title">
                <i class="ti-layout-grid3"></i> <font color="blue"><b>Runners Details</b></font>
                   </h2><p></p>
